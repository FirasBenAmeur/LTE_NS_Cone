...
/* * * * * *
 * Sana AMRI - july 2018
 * Adding the lookup table option "src/Common/LookUpTable2D.*"	 
...
/**
 * This class represents the interface for a MutationLibrarypp.i *
 * @author Andrea Lani
...
public:
   ...
   * @pre this function ALWAYS computes the composition 
	 * https://github.com/andrealani/COOLFluiD/blob/master/src/Framework/PhysicalChemicalLibrary.hh
   */
